...
namespace CursoMOD119.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Email,Active,age")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Email,Active,age")] Client client)
        {
            if (id != client.ID)
            {
                return NotFound();
